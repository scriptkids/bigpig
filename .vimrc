...
autocmd FileType python map <F12> :!python2 %<CR>
...
autocmd! BufNewFile * silent! or ~/.vim/skel/Template.%:e
" 打开javascript折叠
...
"
"=================== SrcExpl ====================
nmap <F2> :SrcExplToggle<CR>    "快捷键映射
